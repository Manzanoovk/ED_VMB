...
public class Main {
        ...
        public static void main(String[] args) {
                ...
                System.out.println(
                                "El peso de " + persona1.getNombre() + " en " + planeta1.getNombre() + " es: "
                                                + pesoTierra + "N");

                System.out.println(
                                "El peso de " + persona2.getNombre() + " en " + planeta2.getNombre() + " es: "
                                                + pesoMarte + "N");

                System.out.println(
                                "El peso de " + persona1.getNombre() + " en " + planeta3.getNombre() + " es: "
                                                + pesoJupiter + "N");
